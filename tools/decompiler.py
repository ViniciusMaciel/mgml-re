...
def convert_c_to_asm(function_name, c_code, asm_code):
    ...
    try:
        messages=[
                    {"role": "system", "content": "You are an assistant that converts Assembly code to C.Please return just the code and anymore. If this code call another function please return a mock function with needed parameters"},
